(()=>{
  ...
  if(!document.querySelector('script[data-seasoncrew-crew-delete]')){
    const script=document.createElement('script');script.src='./crew-delete.js?v=4';script.defer=true;script.dataset.seasoncrewCrewDelete='1';document.head.appendChild(script);
  }
