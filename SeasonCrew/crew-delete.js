(()=>{
  ...
  if(!document.querySelector('script[data-seasoncrew-product-v2]')){
    const script=document.createElement('script');script.src='./product-v2.js?v=5';script.defer=true;script.dataset.seasoncrewProductV2='1';document.head.appendChild(script);
  }
