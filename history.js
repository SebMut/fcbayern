...
const content=document.getElementById("content"),userFilter=document.getElementById("userFilter"),typeFilter=document.getElementById("typeFilter"),search=document.getElementById("search");
let LOGS=[];
